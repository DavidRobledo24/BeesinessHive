...
const signUpComprador = () => {
  const usuario = useState("comprador");
  ...
  //   } else if (name === "politicaPrivacidad") {
  //     setPoliticaPrivacidad(checked);
  //   }
  // };
...
try{
  ...
  return (
    <>
    <Navbar/>
    <div className={style.signUpComprador}>
      <h2>
      ...
      <form action="" onSubmit={handleSubmit} ref={form}>
        ...
        <div>
          ...
          {cedulaError ? (
            ...
            >
              La cedula debe tener entre 5 a 10 caracteres
            </p>
          ) : (
            ""
          )}
          {cedulaNegativaError ? (
            ...
            >
              La cedula no puede ser un numero negativo
            </p>
          ) : (
            ""
          )}
        ...
        <div>
          ...
          {/* {correoError ? (
            ...
            >
              El email debe tener la estructura de una dirección de correo
              electrónico. Verbigracia: alguien@gmail.com
            </p>
          ) : (
            ""
          )} */}
        ...
        <div>
          ...
          {contrasenaError ? (
            ...
            >
              ...
              solicitados(Mínimo 8 caracteres de longitud. Almenos una letra
              mayúscula. Almenos una letra minúscula. Almenos un número. Almenos
              un caracter especial).
            </p>
          ) : (
            ""
          )}
          {contrasenaLargaError ? (
            <p
              style={{
                color: "red",
                fontSize: 15,
            ...
            >
              La contraseña no puede exceder 60 caracteres
            </p>
          ) : (
            ""
          )}
